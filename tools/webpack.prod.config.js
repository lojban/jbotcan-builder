    ...
    loaders: [
      {
        ...
        loader: ExtractTextPlugin.extract('style', ['css?minimize&modules&importLoaders=1&localIdentName=[local]', 'postcss'])
      }, {
        test: webpackIsomorphicToolsPlugin.regular_expression('images'),
        loaders: ['file?name=img/[sha512:hash:base64:7].[ext]', 'image-webpack?optimizationLevel=7&progressive=true']
      }
    ]
  },
  postcss: function() {
